...
```text
infra/docker-compose.yml : postgres(pgvector), redis, minio(s3)
pnpm install
pnpm db:migrate && pnpm db:seed
pnpm dev            # turbo: api, web-resident, web-admin, ai-worker 병렬
```
...
| 3. 시설/회의 | 시설 도우미·회의록 요약 | 회귀 평가·검수 통과 |
...
아키텍처 결정 변경 시 여기 추가(번호·날짜·결정·이유·영향). 초기 ADR-1~6: [01 §12](01-architecture.md).

| # | 날짜 | 결정 | 상태 |
|---|------|------|------|
| 1–6 | 2026-06-20 | [01 §12] 초기 결정 | 적용 |
